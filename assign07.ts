...
let newUsers = ["salman ", "raza", "admin", "ahad", "rizwan"];
...
// 32. Remove all of the usernames from your array, and make sure the correct message is printed.
// Checking Usernames: Do the following to create a program that simulates how websites ensure that everyone has a unique username.
// • Make a list of five or more usernames called current_users.
let currentUsers = ["mian", "umar", "butt", "rana", "jutt"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let newUser = ["ali", "hamza", "hassan", "khan", "ibrahim"];
...
// 34. Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in a array, and then 
// use a for loop to print the name of each pizza.
let favPizza = ["BBQ", "bhari kabab", "mali Boti", "Fajita"];
...
// animals in a list, and then use a for loop to print out the name of each animal. • Modify your program to print a statement about each animal, such as A dog would make a great pet. •
...
describe_city("new dehli"); //with defaultcountry
